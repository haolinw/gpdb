...
LLVMTypeRef TypeMemTupleBindFlag;
...
LLVMTypeRef StructMemTupleAttrBinding;
...
llvm_create_types(void)
{
    ...
    TypeMemTupleBindFlag = load_type(mod, "TypeMemTupleBindFlag");
    ...
    StructMemTupleAttrBinding = load_type(mod, "StructMemTupleAttrBinding");
