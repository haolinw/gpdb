					 ...
					 int64 phyrow, bool *chkvisimap, TupleTableSlot *slot)
{
	...
	elogif(Debug_appendonly_print_datumstream, LOG,
		   "aocs_gettuple_column(): [attno: %d, targrow: %ld, startrow: %ld, expect segno: %d, rownum: %ld, "
		   "actual segno in buffer: %d, segfirstrow: %ld, segrowsprocessed: %ld, nth: %d, blockFirstRowNum: %ld, "
