							  ...
							  TableScanDesc scan)
{
	...
	else if (numblocks != InvalidBlockNumber)
	{
		...
		else
		{
			 ...
			 *
			 * Do nothing in this case. The scan will start anyway from the first
			 * row present in the segfile. This will ensure that we don't skip
			 * the other possibly extant blocks in the range.
			 */
		}
	}
