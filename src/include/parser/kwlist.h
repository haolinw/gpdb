...
PG_KEYWORD("ao_aux_only", AO_AUX_ONLY, TYPE_FUNC_NAME_KEYWORD) /* GPDB */
...
PG_KEYWORD("cpu_hard_quota_limit", CPU_HARD_QUOTA_LIMIT, UNRESERVED_KEYWORD)
PG_KEYWORD("cpu_soft_priority", CPU_SOFT_PRIORITY, UNRESERVED_KEYWORD)
...
PG_KEYWORD("endpoint", ENDPOINT, UNRESERVED_KEYWORD)
...
PG_KEYWORD("io_limit", IO_LIMIT, UNRESERVED_KEYWORD)
...
PG_KEYWORD("min_cost", MIN_COST, UNRESERVED_KEYWORD)
...
PG_KEYWORD("retrieve", RETRIEVE, UNRESERVED_KEYWORD)
