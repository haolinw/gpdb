...
#define AOVISIMAP_ALLVISIBLESET_MAX_RANGE_COUNT ((AOTupleId_MaxRowNum + 1) >> 15)

/* AOVISIMAP_ALLVISIBLESET_MAX_RANGE_COUNT / BITS_PER_BITMAPWORD / APPENDONLY_VISIMAP_MAX_BITMAP_WORD_COUNT = 2^10 */
#define AOVISIMAP_ALLVISIBLESET_MAX_BMS_COUNT (AOVISIMAP_ALLVISIBLESET_MAX_RANGE_COUNT >> 15)
