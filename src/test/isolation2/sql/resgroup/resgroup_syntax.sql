...
CREATE RESOURCE GROUP rg_test_group WITH (concurrency=10, cpu_hard_quota_limit=10, io_limit='pg_default:rbps=1000,wbps=1000,riops=1000,wiops=1000');
DROP RESOURCE GROUP rg_test_group;

-- negative: io limit with incorrect syntax
-- * must be unique tablespace
CREATE RESOURCE GROUP rg_test_group WITH (concurrency=10, cpu_hard_quota_limit=10, io_limit='pg_default:rbps=1000,wbps=1000,riops=1000,wiops=1000;*:wbps=1000');

-- tail ;
CREATE RESOURCE GROUP rg_test_group WITH (concurrency=10, cpu_hard_quota_limit=10, io_limit='pg_default:rbps=1000,wbps=1000,riops=1000,wiops=1000;');

-- tail ,
CREATE RESOURCE GROUP rg_test_group WITH (concurrency=10, cpu_hard_quota_limit=10, io_limit='pg_default:rbps=1000,wbps=1000,riops=1000,');
